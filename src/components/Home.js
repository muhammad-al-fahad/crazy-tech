                        ...
                        <div className='service__card'>
                            <div className='service__card--area'>
                                <div className='service__card--content'>
                                    ...
                                    <div className='service__card--info'>
                                        <div className='service__card--info-title'>Mobile App Development</div>
                                        <div className='service__card--dsc'>We have dedicated full stack developers team for front-end and back-end development.</div>
                                    </div>
                        ...
                        <div className='service__card'>
                            <div className='service__card--area'>
                                <div className='service__card--content'>
                                    ...
                                    <div className='service__card--info'>
                                        <div className='service__card--info-title'>SEO & Social Media Marketing</div>
                                        <div className='service__card--dsc'>We have dedicated full stack developers team for front-end and back-end development.</div>
                                    </div>
                        ...
                        <div className='service__card'>
                            <div className='service__card--area'>
                                <div className='service__card--content'>
                                    ...
                                    <div className='service__card--info'>
                                        <div className='service__card--info-title'>Graphic Design</div>
                                        <div className='service__card--dsc'>We have dedicated full stack developers team for front-end and back-end development.</div>
                                    </div>
                                    ...
                                    <div className='service__card--list'>
                                        <div className='service__card--list-item'>
                                            <img src='/check.svg' alt='Check' /> 
                                            <div className='service__card--list-title'>Logos and branded elements</div>
                                        </div>
                                        <div className='service__card--list-item'>
                                            <img src='/check.svg' alt='Check' /> 
                                            <div className='service__card--list-title'>Business cards, letterhead & envelopes</div>
                                        </div>
                                        <div className='service__card--list-item'>
                                            <img src='/check.svg' alt='Check' />  
                                            <div className='service__card--list-title'>Posters, banners and signage</div>
                                        </div>
                                        <div className='service__card--list-item'>
                                            <img src='/check.svg' alt='Check' /> 
                                            <div className='service__card--list-title'>Brochures, rack cards & booklets</div>
                                        </div>
                                        <div className='service__card--list-item'>
                                            <img src='/check.svg' alt='Check' />  
                                            <div className='service__card--list-title'>Email marketing graphics</div>
                                        </div>
                                        <div className='service__card--list-item'>
                                            <img src='/check.svg' alt='Check' /> 
                                            <div className='service__card--list-title'>Social media & digital marketing Ads</div>
                                        </div>
                                    </div>
                                </div>
                                <div className='service__card--component'></div>
                        ...
                        <div className='service__card'>
                            <div className='service__card--area'>
                                <div className='service__card--content'>
                                    ...
                                    <div className='service__card--info'>
                                        <div className='service__card--info-title'>Cloud / DevOps Development</div>
                                        <div className='service__card--dsc'>We have dedicated full stack developers team for front-end and back-end development.</div>
                                    </div>
                        ...
                        <div className='service__card'>
                            <div className='service__card--area'>
                                <div className='service__card--content'>
                                    ...
                                    <div className='service__card--info'>
                                        <div className='service__card--info-title'>Software QA & Testing</div>
                                        <div className='service__card--dsc'>We have dedicated full stack developers team for front-end and back-end development.</div>
                                    </div>
